            ...
            var createParticle = function () {
				...
				particle.position = [2, 0, Math.random()];
				//document.write(Math.random() + "<br>"); TODO: remove 
                //particle.velocity = [-Math.random(), -Math.random(), Math.random()];
				particle.velocity = [-10, -1, 1];
			...
			//G: creates particle system and with specified number of particles and defines their properties
